...
def novo_numero():
    ...
    if modo_jogo == "Numeros":
        if dificuldade.get() == "Muito Fácil":
            numero_aleatorio = random.randint(1, 20)
        elif dificuldade.get() == "Fácil":
...
radiobtn_mtfacil = tk.Radiobutton(frame_superior, text="Muito Fácil", variable=dificuldade, value="Muito Fácil")
radiobtn_mtfacil.pack(anchor=tk.W)
